        ...
        <section id="hero">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <!-- Slide 1 -->
                <div class="carousel-item active" style="background-image: url(hm/img/slide/slide-1.jpg)">
                </div>

                <!-- Slide 2 -->
                <div class="carousel-item" style="background-image: url(hm/img/slide/slide-2.jpg)">  
                </div>

                <!-- Slide 3 -->
                <div class="carousel-item" style="background-image: url(hm/img/slide/slide-3.jpg)">  
                </div>        
        ...
        <main id="main">   
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="col-lg-6" data-aos="fade-right">
                    <img src="{{asset('hm/img/about.png')}}" class="img-fluid" alt="">
                </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="tab-pane active show" id="tab-1">
                        ...
                        <img src="{{asset('hm/img/rpl.jpg')}}" alt="" class="img-fluid">
                    ...
                    <div class="tab-pane" id="tab-2">
                        ...
                        <img src="{{asset('hm/img/administrasi.jpg')}}" alt="" class="img-fluid">
                    ...
                    <div class="tab-pane" id="tab-3">
                        ...
                        <img src="{{asset('hm/img/akuntansi.jpg')}}" alt="" class="img-fluid">
            ...
            <div class="buat_akun" data-aos="zoom-in">
                ...
                <p></p>
                <a class="cta-btn scrollto" href="{{ route('register') }}">Buat Akun</a>
                </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    ...
                    <div class="member-img">
                        <img src="{{asset('hm/img/slide/slide-1.jpg')}}" class="img-fluid" alt="">
                    </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    ...
                    <div class="member-img">
                        <img src="{{asset('hm/img/slide/slide-8.jpg')}}" class="img-fluid" alt="">
                    </div>
                    <div class="member-info">
                        <h4>Aula</h4>
                        <span></span>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    ...
                    <div class="member-img">
                        <img src="{{asset('hm/img/slide/slide-5.jpg')}}" class="img-fluid" alt="">
                    </div>
                    <div class="member-info">
                        <h4>Unit Bisnis</h4>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    ...
                    <div class="member-img">
                        <img src="{{asset('hm/img/slide/slide-6.jpg')}}" class="img-fluid" alt="">
                    </div>
                    <div class="member-info">
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    ...
                    <div class="member-img">
                        <img src="{{asset('hm/img/slide/slide-7.jpg')}}" class="img-fluid" alt="">
                    </div>
                    <div class="member-info">
                        <h4>Lab Bisnis</h4>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    ...
                    <div class="member-img">
                        <img src="{{asset('hm/img/slide/slide-4.jpg')}}" class="img-fluid" alt="">
                    </div>
                    <div class="member-info">
                        <h4>Homestay</h4>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="testimonial-item">
                    ...
                    <img src="{{asset('hm/img/testimonials/wikan.jpg')}}" class="testimonial-img" alt="">
                ...
                <div class="testimonial-item">
                    ...
                    <img src="{{asset('hm/img/testimonials/andang.jpg')}}" class="testimonial-img" alt="">
                ...
                <div class="testimonial-item">
                    ...
                    <img src="{{asset('hm/img/testimonials/testimonials-3.jpg')}}" class="testimonial-img" alt="">
                    <h3>Dr. Muhammad Zainuddin,M.Sc.</h3>
                    <h4>PD 3 Polibatam</h4>
                </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <a href="{{asset('hm/img/gallery/gallery-1.jpg')}}" class="venobox" data-gall="gallery-carousel"><img src="{{asset('hm/img/gallery/gallery-1.jpg')}}" alt=""></a>
                <a href="{{asset('hm/img/gallery/gallery-2.jpg')}}" class="venobox" data-gall="gallery-carousel"><img src="{{asset('hm/img/gallery/gallery-2.jpg')}}" alt=""></a>
                <a href="{{asset('hm/img/gallery/gallery-3.jpg')}}" class="venobox" data-gall="gallery-carousel"><img src="{{asset('hm/img/gallery/gallery-3.jpg')}}" alt=""></a>
                <a href="{{asset('hm/img/gallery/gallery-4.jpg')}}" class="venobox" data-gall="gallery-carousel"><img src="{{asset('hm/img/gallery/gallery-4.jpg')}}" alt=""></a>
                <a href="{{asset('hm/img/gallery/gallery-5.jpg')}}" class="venobox" data-gall="gallery-carousel"><img src="{{asset('hm/img/gallery/gallery-5.jpg')}}" alt=""></a>
                <a href="{{asset('hm/img/gallery/gallery-6.jpg')}}" class="venobox" data-gall="gallery-carousel"><img src="{{asset('hm/img/gallery/gallery-6.jpg')}}" alt=""></a>
                <a href="{{asset('hm/img/gallery/gallery-7.jpg')}}" class="venobox" data-gall="gallery-carousel"><img src="{{asset('hm/img/gallery/gallery-7.jpg')}}" alt=""></a>
                <a href="{{asset('hm/img/gallery/gallery-8.jpg')}}" class="venobox" data-gall="gallery-carousel"><img src="{{asset('hm/img/gallery/gallery-8.jpg')}}" alt=""></a>
                <a href="{{asset('hm/img/gallery/gallery-9.jpg')}}" class="venobox" data-gall="gallery-carousel"><img src="{{asset('hm/img/gallery/gallery-9.jpg')}}" alt=""></a>
                <a href="{{asset('hm/img/gallery/gallery-10.jpg')}}" class="venobox" data-gall="gallery-carousel"><img src="{{asset('hm/img/gallery/gallery-10.jpg')}}" alt=""></a>
                </div>
